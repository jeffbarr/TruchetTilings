...
| TruchetMode(CircledTriad) | TruchetMode(3-4-5-6 + RandomSeed), Seed(131313) |
| --- | --- |
| ![Example 1](Images/ht_example_1.jpg) | ![Example 2](Images/ht_example_2.jpg) |
| **TruchetMode(5),RotateFactor(7),RotateMod(3)** | **TruchetMode(LineCircleWave)** |
| ![Example 3](Images/ht_example_3.jpg) | ![Example 4](Images/ht_example_4.jpg) | 
| **TruchetMode(3-4-5-6 + FactorMod), Factor(4), Mod(3)**| - |
| ![Example 5](Images/ht_example_5.jpg) | - |
...
* **TruchetMode** - Controls which of the truchet tiles are used. **1**, **2**, **3**, **4**, **5**, and **6** specify individual tiles. **1-2 + RandomSeed** specifies tiles 1 and 2, and **3-4-5-6 + RandomSeed** specifies tiles 3, 4, 5, and 6. **CircledTriad** specifies the circled triad pattern, **LineCircleWave** specifies the line/circle/wave pattern, and **LineZigZag** specifies the line zigzag pattern. For modes **1-2 + RandomSeed** and **3-4-5-6 + RandomSeed** is used to start the pseudo-random number generator. You will need to capture and retain this value if you are trying to repeat patterns that you created earlier. **1-2 + FactorMod** specifies tiles 1 and 2, chosen by combining X, Y, **RotateFactor**, and **RotateMod**. Similarly, **3-4-5-6 + FactorMod** specifies tiles 3,4, 5, and 6 chosen by X, Y. **RotateFactor**, and **RotateMod**.
...
* **RotateFactor** - Drives the rotation if **Rotate** is set. Drives tile selection for the **FactorMod** modes. See the code to learn more.
* **RotateMod** - Also drives the rotation if **Rotate** is set. Drives tile selection for the **FactorMod** modes.

NB - **RotateFactor** and **RotateMod** are now more general than just for rotation, and will be renamed.
## Grid
